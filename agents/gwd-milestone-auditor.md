...
```
Task(prompt="Re-verify phase 1...", subagent_type="gwd-verifier")
Task(prompt="Re-verify phase 2...", subagent_type="gwd-verifier")
Task(prompt="Re-verify phase 3...", subagent_type="gwd-verifier")
Task(prompt="Re-verify phase 4...", subagent_type="gwd-verifier")
Task(prompt="Re-verify phase 5...", subagent_type="gwd-verifier")
```
...
Create integration report.",
  subagent_type="gwd-integration-checker"
)
```
...
_Auditor: Claude (gwd-milestone-auditor)_
```
