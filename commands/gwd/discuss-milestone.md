...
Output: Context gathered, then routes to /gwd:new-milestone
</objective>

<execution_context>
@~/.claude/get-work-done/references/principles.md
@~/.claude/get-work-done/workflows/discuss-milestone.md
</execution_context>
...
4. Hand off to /gwd:new-milestone with gathered context
