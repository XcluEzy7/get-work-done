...
- Example: `/gwd:add-phase Add authentication` → description = "Add authentication"
- Example: `/gwd:add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /gwd:add-phase <description>
Example: /gwd:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /gwd:plan-phase {N} to break down)
...
**Also available:**
- `/gwd:add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /gwd:insert-phase)
- Don't create plans yet (that's /gwd:plan-phase)
