...
@~/.claude/get-work-done/workflows/plan-phase.md
@~/.claude/get-work-done/templates/phase-prompt.md
@~/.claude/get-work-done/references/plan-format.md
@~/.claude/get-work-done/references/scope-estimation.md
...
**Load phase context if exists (created by /gwd:discuss-phase):**
...
<process>
1. Check .planning/ directory exists (error if not - user should run /gwd:new-project)
