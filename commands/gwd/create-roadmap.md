...
Run after `/gwd:define-requirements`.
</objective>

<execution_context>
@~/.claude/get-work-done/references/principles.md
@~/.claude/get-work-done/workflows/create-roadmap.md
@~/.claude/get-work-done/templates/roadmap.md
@~/.claude/get-work-done/templates/state.md
@~/.claude/get-work-done/references/goal-backward.md
</execution_context>
...
[ -f .planning/REQUIREMENTS.md ] || { echo "ERROR: No REQUIREMENTS.md found. Run /gwd:define-requirements first."; exit 1; }
```
</step>
...
**Also available:**
- `/gwd:discuss-phase 1` — gather context first
- `/gwd:research-phase 1` — investigate unknowns
- Review roadmap
