...
<execution_context>
@~/.claude/get-work-done/workflows/map-codebase.md
@~/.claude/get-work-done/templates/codebase/stack.md
@~/.claude/get-work-done/templates/codebase/architecture.md
@~/.claude/get-work-done/templates/codebase/structure.md
@~/.claude/get-work-done/templates/codebase/conventions.md
@~/.claude/get-work-done/templates/codebase/testing.md
@~/.claude/get-work-done/templates/codebase/integrations.md
@~/.claude/get-work-done/templates/codebase/concerns.md
</execution_context>
...
- Before /gwd:new-project (brownfield codebases) - creates codebase map first
- After /gwd:new-project (greenfield codebases) - updates codebase map as code evolves
...
6. Offer next steps (typically: /gwd:new-project or /gwd:plan-phase)
</process>
