...
Run after `/gwd:new-project`, before `/gwd:define-requirements`.
...
@~/.claude/get-work-done/workflows/research-project.md
@~/.claude/get-work-done/templates/research-project/SUMMARY.md
@~/.claude/get-work-done/templates/research-project/STACK.md
@~/.claude/get-work-done/templates/research-project/FEATURES.md
@~/.claude/get-work-done/templates/research-project/ARCHITECTURE.md
@~/.claude/get-work-done/templates/research-project/PITFALLS.md
</execution_context>
...
[ -f .planning/PROJECT.md ] || { echo "ERROR: No PROJECT.md found. Run /gwd:new-project first."; exit 1; }
