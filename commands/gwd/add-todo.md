...
<objective>
Capture an idea, task, or issue that surfaces during a GWD session as a structured todo for later work.
...
- `/gwd:add-todo Add auth token refresh` → title = "Add auth token refresh"
...
2. Add another todo
3. View all todos (/gwd:check-todos)
```
</step>
