...
Output: {phase}-UAT.md tracking all test results, gaps logged for /gwd:plan-phase --gaps
</objective>

<execution_context>
@~/.claude/get-work-done/workflows/verify-work.md
...
- Don't fix issues during testing — log as gaps for /gwd:plan-phase --gaps
</anti_patterns>
