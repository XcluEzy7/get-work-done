...
- Example: `/gwd:remove-phase 17` → phase = 17
- Example: `/gwd:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /gwd:remove-phase <phase-number>
Example: /gwd:remove-phase 17
```
...
To abandon current work, use /gwd:pause-work instead.
```
...
Would you like to:
- `/gwd:progress` — see updated roadmap status
