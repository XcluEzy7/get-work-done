---
name: gwd:whats-new
description: See what's new in GWD since your installed version
---
...
```bash
cat ~/.claude/get-work-done/VERSION 2>/dev/null
```
...
**To fix:** `npx get-work-done-cc --global`
...
- URL: `https://raw.githubusercontent.com/XcluEzy7/get-work-done/main/CHANGELOG.md`
...
```bash
cat ~/.claude/get-work-done/CHANGELOG.md 2>/dev/null
```
...
[View full changelog](https://github.com/XcluEzy7/get-work-done/blob/main/CHANGELOG.md)
```
...
**To update:** `npx get-work-done-cc --global`
```
