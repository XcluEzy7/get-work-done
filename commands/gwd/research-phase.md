...
@~/.claude/get-work-done/workflows/research-phase.md
@~/.claude/get-work-done/templates/research.md
@~/.claude/get-work-done/references/research-pitfalls.md
</execution_context>
