...
1. ~/.claude/get-work-done/templates/research-project/SUMMARY.md
2. ~/.claude/get-work-done/templates/research-project/STACK.md
3. ~/.claude/get-work-done/templates/research-project/FEATURES.md
4. ~/.claude/get-work-done/templates/research-project/ARCHITECTURE.md
5. ~/.claude/get-work-done/templates/research-project/PITFALLS.md
...
- Read ~/.claude/get-work-done/templates/research-project/STACK.md for format
...
Use this template structure:
- Read ~/.claude/get-work-done/templates/research-project/FEATURES.md for format
...
Use this template structure:
- Read ~/.claude/get-work-done/templates/research-project/ARCHITECTURE.md for format
...
Use this template structure:
- Read ~/.claude/get-work-done/templates/research-project/PITFALLS.md for format
