...
**If .planning/ doesn't exist:** This is a new project - route to /gwd:new-project
</step>
...
⚠️  Interrupted agent detected:
    ...
    Resume with: /gwd:resume-task

[If pending todos exist:]
📋 [N] pending todos — /gwd:check-todos to review
...
→ Primary: Resume interrupted agent (/gwd:resume-task)
...
1. Resume interrupted agent (/gwd:resume-task) [if interrupted agent found]
   OR
1. Resume from checkpoint (/gwd:execute-plan .planning/phases/XX-name/.continue-here-02-01.md)
   OR
1. Execute next plan (/gwd:execute-plan .planning/phases/XX-name/02-02-PLAN.md)
   OR
1. Discuss Phase 3 context (/gwd:discuss-phase 3) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 (/gwd:plan-phase 3) [if CONTEXT.md exists or discuss option declined]
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Also available:**
  - `/gwd:discuss-phase [N]` — gather context first
  - `/gwd:research-phase [N]` — investigate unknowns
