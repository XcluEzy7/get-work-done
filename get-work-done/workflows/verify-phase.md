...
- ~/.claude/get-work-done/references/goal-backward.md (derivation process)
- ~/.claude/get-work-done/references/verification-patterns.md (detection patterns)
- ~/.claude/get-work-done/templates/verification-report.md (output format)
</required_reading>
...
See ~/.claude/get-work-done/references/goal-backward.md for detailed derivation guidance.
</step>
...
See ~/.claude/get-work-done/templates/verification-report.md for complete template.
</step>
