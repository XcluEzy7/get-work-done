...
Did you want to:
1. Complete current milestone first (/gwd:complete-milestone)
2. Add phases to current milestone (/gwd:add-phase)
...
- options (ALL THREE REQUIRED):
  - "Create milestone" - Proceed to /gwd:new-milestone
...
Use template from ~/.claude/get-work-done/templates/milestone-context.md
...
- Context handed off to /gwd:new-milestone
</success_criteria>
