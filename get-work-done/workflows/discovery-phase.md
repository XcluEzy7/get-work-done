...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /gwd:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/get-work-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Quality check:** Before finalizing findings, consult ~/.claude/get-work-done/references/research-pitfalls.md to avoid common research gaps.

7. **Create DISCOVERY.md** using ~/.claude/get-work-done/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/get-work-done/templates/discovery.md:
...
6. **Quality check:** Before finalizing findings, consult ~/.claude/get-work-done/references/research-pitfalls.md to ensure comprehensive coverage and avoid common research gaps.

7. **Create comprehensive DISCOVERY.md:**

   - Full structure from ~/.claude/get-work-done/templates/discovery.md
...
Use ~/.claude/get-work-done/templates/discovery.md.
...
1. Discuss phase context (/gwd:discuss-phase [current-phase])
2. Create phase plan (/gwd:plan-phase [current-phase])
