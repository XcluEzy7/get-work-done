...
<references>
@~/.claude/get-work-done/references/debugging/debugging-mindset.md
@~/.claude/get-work-done/references/debugging/hypothesis-testing.md
@~/.claude/get-work-done/references/debugging/investigation-techniques.md
@~/.claude/get-work-done/references/debugging/verification-patterns.md
@~/.claude/get-work-done/references/debugging/when-to-research.md
</references>

<template>
@~/.claude/get-work-done/templates/DEBUG.md
</template>
...
"Context filling up. Safe to /clear - run /gwd:debug to resume."
</step>
...
**Do NOT proceed to fix_and_verify.** The fix will be planned by /gwd:plan-phase --gaps using this diagnosis.
</step>
...
- question: "What now?"
- options:
  - "Continue working" - Back to /gwd:progress
