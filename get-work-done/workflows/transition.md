...
Exit skill and invoke SlashCommand("/gwd:plan-phase [X+1]")
...
**Also available:**
- `/gwd:discuss-phase [X+1]` — gather context first
- `/gwd:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/gwd:complete-milestone {version}")
