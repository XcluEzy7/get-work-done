...
1. ~/.claude/get-work-done/references/questioning.md
2. ~/.claude/get-work-done/templates/project.md
...
**If MILESTONE-CONTEXT.md exists (from /gwd:discuss-milestone):**
...
Phase: Not started (run /gwd:create-roadmap)
Plan: —
...
**Or research first:**
- `/gwd:research-project` — investigate ecosystem before scoping

**Full flow:**
1. `/gwd:define-requirements` — create REQUIREMENTS.md
2. `/gwd:create-roadmap` — create ROADMAP.md with phases
3. `/gwd:plan-phase [N]` — start execution
