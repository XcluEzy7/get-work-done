...
2. Read `~/.claude/get-work-done/templates/milestone-archive.md` template
...
**Important:** The next milestone workflow starts with `/gwd:define-requirements` to create a fresh REQUIREMENTS.md. PROJECT.md's Validated section carries the cumulative record across milestones.
...
- [ ] User knows next steps (starting with /gwd:define-requirements)
