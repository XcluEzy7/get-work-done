...
│   └── gsd/           # GWD-specific commands
├── get-work-done/     # Skill resources
...
**New Template:**
- Implementation: `get-work-done/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `get-work-done/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/get-work-done/workflows/{name}.md`

**New Reference Document:**
- Implementation: `get-work-done/references/{name}.md`
