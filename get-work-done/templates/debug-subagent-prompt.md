...
- `/gwd:debug` — Interactive debugging (find and offer to fix)
...
<execution_context>
@~/.claude/get-work-done/workflows/debug.md
...
- `find_and_fix` — Find root cause, then fix and verify. Used by interactive /gwd:debug where user wants immediate resolution.
</mode>
