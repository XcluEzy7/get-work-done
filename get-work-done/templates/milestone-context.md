...
**Purpose:** Persist milestone discussion context so `/clear` can be used between commands. This file is consumed by `/gwd:new-milestone` and deleted after the milestone is created.
...
**Generated:** [date]
**Status:** Ready for /gwd:new-milestone
...
*This file is temporary. It will be deleted after /gwd:new-milestone creates the milestone.*
```
...
**Lifecycle:**
1. `/gwd:discuss-milestone` creates this file at end of discussion
2. User runs `/clear` (safe now - context is persisted)
3. `/gwd:new-milestone` reads this file
4. `/gwd:new-milestone` uses context to populate milestone
5. `/gwd:new-milestone` deletes this file after successful creation
